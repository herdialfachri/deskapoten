...
<?= $this->section('title') ?>Website<?= $this->endSection() ?>
...
<div class="header-carousel owl-carousel">
    <div class="header-carousel-item">
        <img src="user/img//deska.jpg" class="img-fluid w-100" alt="Image">
                ...
                <div class="row gy-0 gx-5">
                    ...
                    <div class="col-xl-7 animated fadeInLeft">
                        <div class="text-sm-center text-md-end">
                            <h4 class="text-primary text-uppercase fw-bold mb-4">Selamat Datang di Simpakal</h4>
                            <h1 class="display-4 text-uppercase text-white mb-4">Sistem Manajemen Potensi Kalapanunggal</h1>
                            <p class="mb-5 fs-5">Simpakal adalah sebuah platform berbasis website yang dirancang untuk mengelola dan menampilkan potensi sumber daya yang ada di kecamatan Kalapanunggal, Kab. Sukabumi, Jawa Barat.
                            </p>
                            <div class="d-flex justify-content-center justify-content-md-end flex-shrink-0 mb-4">
                                <a class="btn btn-light rounded-pill py-3 px-4 px-md-5 me-2" href="https://youtu.be/1d-GaRKb7EU?si=bQ5Sot9WLVPheEV4" target="_blank"><i class="fas fa-play-circle me-2"></i> Tonton</a>
                                <a class="btn btn-primary rounded-pill py-3 px-4 px-md-5 ms-2" href="https://sukabumikab.bps.go.id/id/publication/2022/09/26/cd3001777083b46e670eec15/kecamatan-kalapanunggal-dalam-angka-2022.html" target="_blank"><i class="fas fa-book me-2"></i>Baca</a>
                            </div>
                            <div class="d-flex align-items-center justify-content-center justify-content-md-end">
                                <!-- <h2 class="text-white me-2">Follow Us:</h2> -->
                                <div class="d-flex justify-content-end ms-2">
                                    <a class="btn btn-md-square btn-light rounded-circle me-2" href="https://facebook.com/kecklp" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                    <a class="btn btn-md-square btn-light rounded-circle mx-2" href="#"><i class="fab fa-twitter"></i></a>
                                    <a class="btn btn-md-square btn-light rounded-circle mx-2" href="https://www.instagram.com/kec_klp/" target="_blank"><i class="fab fa-instagram"></i></a>
    ...
    <div class="header-carousel-item">
        <img src="user/img//deska2.jpg" class="img-fluid w-100" alt="Image">
        <div class="carousel-caption">
            <div class="container">
                <div class="row g-5">
                    <div class="col-12 animated fadeInUp">
                        <div class="text-center">
                            ...
                            <div class="d-flex justify-content-center flex-shrink-0 mb-4">
                                <a class="btn btn-light rounded-pill py-3 px-4 px-md-5 me-2" href="https://youtu.be/XT6zSY7_P5E?si=g8qejtay7tCmVVTw" target="_blank"><i class="fas fa-play-circle me-2"></i> Watch Video</a>
            ...
            <div class="col-xl-7 wow fadeInRight" data-wow-delay="0.4s">
                <div class="tab-content">
                    <div id="collapseOne" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            <div class="col-md-7">
                                <img src="user/img//offer-1.jpg" class="img-fluid w-100 rounded" alt="">
                            </div>
                            <div class="col-md-5">
                    ...
                    <div id="collapseTwo" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-md-7">
                                <img src="user/img//offer-2.jpg" class="img-fluid w-100 rounded" alt="">
                            </div>
                            <div class="col-md-5">
                                <h1 class="display-5 mb-4">The stock market provides a venue...</h1>
                                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis amet sequi molestiae tenetur eum mollitia, blanditiis, magnam illo magni error dolore unde perspiciatis tempore et totam corrupti dignissimos aut praesentium?
                    ...
                    <div id="collapseThree" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-md-7">
                                <img src="user/img//offer-3.jpg" class="img-fluid w-100 rounded" alt="">
                            </div>
                            <div class="col-md-5">
                                <h1 class="display-5 mb-4">The stock market provides a venue...</h1>
                                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis amet sequi molestiae tenetur eum mollitia, blanditiis, magnam illo magni error dolore unde perspiciatis tempore et totam corrupti dignissimos aut praesentium?
                    ...
                    <div id="collapseFour" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <div class="col-md-7">
                                <img src="user/img//offer-4.jpg" class="img-fluid w-100 rounded" alt="">
                            </div>
                            <div class="col-md-5">
                                <h1 class="display-5 mb-4">The stock market provides a venue...</h1>
                                <p class="mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis amet sequi molestiae tenetur eum mollitia, blanditiis, magnam illo magni error dolore unde perspiciatis tempore et totam corrupti dignissimos aut praesentium?
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.2s">
                <div class="bg-primary rounded">
                    <img src="user/img//about-2.png" class="img-fluid w-100" alt="">
                </div>
            </div>
        </div>
    </div>
